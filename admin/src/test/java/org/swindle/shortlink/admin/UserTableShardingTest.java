...
public class UserTableShardingTest {
    private static final String SQL="CREATE TABLE `t_link_%d` (\n" +
            ...
            "  `favicon` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '网站标识',\n" +
            ...
            ") ENGINE=InnoDB AUTO_INCREMENT=1897552597647167491 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;";
